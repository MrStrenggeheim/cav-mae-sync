...
#SBATCH --output=slurm_logs_flo/frames_%A_%a.out
#SBATCH --error=slurm_logs_flo/frames_%A_%a.err
#SBATCH --time=08:00:00
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --mem=16G
#SBATCH --array=0-15  # 16 jobs total
...
NUM_SHARDS=16  # Must match the count of --array (0-15 = 16)
